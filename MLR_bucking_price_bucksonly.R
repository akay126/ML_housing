...
intdata$TotalLivSF = intdata$GrLivArea + intdata$TotalBsmtSF
intdata = subset(intdata, select = -c(FirstFlrSF,SecondFlrSF,GrLivArea,TotalBsmtSF))
intdata$TotalLivSF = log10(intdata$TotalLivSF)
...
intdata_nb$TotalLivSF = intdata_nb$GrLivArea + intdata_nb$TotalBsmtSF
intdata_nb = subset(intdata_nb, select = -c(FirstFlrSF,SecondFlrSF,GrLivArea,TotalBsmtSF))
intdata_nb$TotalLivSF = log10(intdata_nb$TotalLivSF)
...
cross_val = function(i){
  ...
  model_nb.full = lm (SalePrice ~ .,data = intdata_nb)
